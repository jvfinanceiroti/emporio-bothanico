  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <section className="relative min-h-[50vh] sm:min-h-[55vh] lg:min-h-[60vh] flex overflow-hidden">
        ...
        {/* Imagens laterais: preenchem os espaços vazios com fotos de produtos/ambiente */}
        <div className="absolute inset-0 pointer-events-none hidden lg:block">
          <div className="absolute left-0 top-0 bottom-0 w-[18%] overflow-hidden">
            <img src="https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=400&q=60" alt="" className="w-full h-full object-cover opacity-30 scale-110" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#2d5a4a]/90 to-transparent" />
          </div>
          <div className="absolute right-0 top-0 bottom-0 w-[18%] overflow-hidden">
            <img src="https://images.unsplash.com/photo-1595425970377-c9703cf48b6d?w=400&q=60" alt="" className="w-full h-full object-cover opacity-30 scale-110" />
            <div className="absolute inset-0 bg-gradient-to-l from-[#2d5a4a]/90 to-transparent" />
          </div>
        </div>
        {/* Conteúdo */}
