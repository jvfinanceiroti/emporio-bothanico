...
export default function ProdutosPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
      ...
      {/* HERO PRODUTOS */}
      <section className="relative py-24 lg:py-32 overflow-hidden bg-[#1c1917]">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1594035910387-fea47794261f?w=1920&q=80')] bg-cover bg-center opacity-25" />
