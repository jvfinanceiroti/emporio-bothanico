      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <a href="mailto:naibari@yahoo.com.br" className="block text-white/70 text-sm hover:text-white transition-colors">📧 naibari@yahoo.com.br</a>
            <a href="https://wa.me/5531995503794" target="_blank" rel="noopener noreferrer" className="block text-white/70 text-sm mt-2 hover:text-white transition-colors">📱 (31) 99550-3794</a>
            <p className="text-white/70 text-sm mt-2">Seg-Sex: 9h às 19h</p>
